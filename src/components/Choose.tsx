    ...
    <>
        ...
        <div className="md:h-[80vh] h-[60vh] md:w-[80vw] m-[4vh] md:m-[10vh] rounded-2xl flex flex-col items-center justify-center bg-white bg-opacity-5 backdrop-blur-md">
            ...
            <div className="grid grid-cols-1 mx-16 my-[2vh] text-center">
                <div className="border-primary text-white border-2 px-12 py-6 text-base rounded-[1rem] mt-12 md:hover:text-[2rem] md:hover:p-8 duration-300 font-Goldman md:w-[30vw]"><Link to="https://anuragspace.github.io/ssform/solo.html">Go Solo</Link></div>
                <div className="border-primary text-white border-2 px-12 py-6 text-base rounded-[1rem] mt-12 md:hover:text-[2rem] md:hover:p-8 duration-300 font-Goldman md:w-[30vw]"><Link to="https://anuragspace.github.io/ssform/team.html">Teamplay</Link></div>
            </div>
        </div>
